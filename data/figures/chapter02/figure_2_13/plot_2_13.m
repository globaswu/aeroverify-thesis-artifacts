function plot_2_13(outputPath)
%PLOT_2_13 Reproduce archived CFD diagnostics from adjacent CSV, without CFD.
...
if nargin < 1, outputPath = fullfile(outDir,'figure_2_13.png'); end
[outputFolder,~,~] = fileparts(outputPath);
if ~isempty(outputFolder) && ~isfolder(outputFolder), mkdir(outputFolder); end
T = readtable(fullfile(outDir, 'figure_2_13.csv'), 'TextType', 'string');
