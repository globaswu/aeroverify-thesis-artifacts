"""Reproduce thesis Figure 2.13 from the sibling CSV only."""
...
DATA_FILE = HERE / "figure_2_13.csv"
DEFAULT_OUTPUT_FILE = HERE / "plot_2_13.png"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Output image file (default: sibling plot_2_13.png)",
    )
