function plot_2_14(outputPath)
%PLOT_2_14 Reproduce the full box-detail diagram from one CSV.
folder = fileparts(mfilename('fullpath'));
if nargin<1 || isempty(outputPath)
    outputPath = fullfile(folder,'figure_2_14.png');
end
data = readtable(fullfile(folder,'figure_2_14.csv'));
