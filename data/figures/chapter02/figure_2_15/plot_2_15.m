function metrics = plot_2_15(outputPath)
%PLOT_2_15 Matched rigid W2GJ on/off comparison from adjacent CSV, without CFD.
...
if nargin < 1 || strlength(string(outputPath)) == 0
    outputPath = fullfile(outDir,'figure_2_15_matlab.png');
end
T = readtable(fullfile(outDir,'figure_2_15.csv'));
