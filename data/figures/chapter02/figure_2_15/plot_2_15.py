"""Plot verified rigid W2GJ on/off lift from adjacent figure_2_15.csv.

Usage: python plot_2_15.py --output PATH.png
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=HERE/"figure_2_15.png")
    args = parser.parse_args()
    with (HERE/"figure_2_15.csv").open(newline="", encoding="utf-8-sig") as stream:
