function plot_2_18(outputPath)
%PLOT_2_18 Reproduce five lift curves and a local CL zoom.
% The only input is the adjacent figure_2_18.csv.
folder=fileparts(mfilename('fullpath'));
if nargin<1 || isempty(outputPath),outputPath=fullfile(folder,'figure_2_18.png');end
data=readtable(fullfile(folder,'figure_2_18.csv'));
