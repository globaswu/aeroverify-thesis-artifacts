...
def main(output: Path):
    ...
    data=np.genfromtxt(folder/'figure_2_18.csv',delimiter=',',names=True,dtype=None,encoding='utf-8')
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',type=Path,default=Path(__file__).with_name('figure_2_18.png'))
