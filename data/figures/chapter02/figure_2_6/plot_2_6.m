function plot_2_6(outputPath)
%PLOT_2_6 Reproduce the complete schematic from the adjacent coordinate CSV.
...
if nargin < 1 || isempty(outputPath)
    outputPath = fullfile(plotDir,'figure_2_6.png');
end
data = readmatrix(fullfile(plotDir,'figure_2_6.csv'));
