...
def load_airfoil_data(script_dir: Path) -> np.ndarray:
    ...
    data = np.loadtxt(script_dir / "figure_2_6.csv", delimiter=",", skiprows=1)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Reproduce Figure 2.6 from its adjacent CSV.")
    parser.add_argument("--output", type=Path, default=Path(__file__).with_name("figure_2_6.png"))
