...
NUMBER = 1
CSV_FILE = SCRIPT.parent / "figure_3_1.csv"
DEFAULT_OUTPUT = SCRIPT.parent / "plot_3_1.png"

PARSER = argparse.ArgumentParser(
    description="Render Thesis Figure 3.1 from its sibling CSV."
)
PARSER.add_argument(
    "--output",
    type=Path,
    default=DEFAULT_OUTPUT,
    help="Output image path (default: sibling plot_3_1.png).",
)
