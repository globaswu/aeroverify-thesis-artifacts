...
NUMBER = 2
CSV_FILE = SCRIPT.parent / "figure_3_2.csv"
DEFAULT_OUTPUT = SCRIPT.parent / "plot_3_2.png"

PARSER = argparse.ArgumentParser(
    description="Render Thesis Figure 3.2 from its sibling CSV."
)
PARSER.add_argument(
    "--output",
    type=Path,
    default=DEFAULT_OUTPUT,
    help="Output image path (default: sibling plot_3_2.png).",
)
