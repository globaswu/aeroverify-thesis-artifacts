...
DATA = HERE / "figure_6_11.csv"
parser = argparse.ArgumentParser(description="Replot thesis Figure 6.11 from its sibling CSV.")
parser.add_argument("--output", type=Path, help="Output image path; defaults beside this script.")
arguments = parser.parse_args()
OUTPUT = (arguments.output if arguments.output is not None else HERE / "plot_6_11.png").resolve()
