...
NUMBER = 4
CSV_FILE = SCRIPT.parent / "figure_C_2.csv"
DEFAULT_OUTPUT = SCRIPT.parent / "plot_C_2.png"

PARSER = argparse.ArgumentParser(
    description="Render Thesis Figure C.2 from its sibling CSV."
)
PARSER.add_argument(
    "--output",
    type=Path,
    default=DEFAULT_OUTPUT,
    help="Output image path (default: sibling plot_C_2.png).",
)
