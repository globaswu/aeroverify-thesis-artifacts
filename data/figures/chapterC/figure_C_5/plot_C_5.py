...
NUMBER = 10
CSV_FILE = SCRIPT.parent / "figure_C_5.csv"
DEFAULT_OUTPUT = SCRIPT.parent / "plot_C_5.png"

PARSER = argparse.ArgumentParser(
    description="Render Thesis Figure C.5 from its sibling CSV."
)
PARSER.add_argument(
    "--output",
    type=Path,
    default=DEFAULT_OUTPUT,
    help="Output image path (default: sibling plot_C_5.png).",
)
